...
const About: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3 text-slate-600 text-left">
  ...
  return (
    <div className="py-20 animate-in fade-in duration-500 relative z-10 selection:bg-yellow-200 selection:text-purple-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Story Section */}
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-24 mb-16 lg:mb-32">
          <div className="lg:w-1/2">
            <span className="text-yellow-500 font-black text-xs uppercase tracking-[0.3em] mb-4 block">About Vidisha</span>
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-black text-purple-950 mb-6 lg:mb-10 leading-tight">
              Building Futures Through Excellence, Dedication & Vision
            </h1>
            <div className="space-y-6 lg:space-y-8 text-base lg:text-lg text-slate-500 leading-relaxed font-medium">
              <p>
              ...
              <div className="bg-slate-50 p-6 lg:p-10 rounded-2xl lg:rounded-[3rem] italic text-purple-900 font-bold leading-relaxed shadow-sm text-sm lg:text-base">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 mb-16 lg:mb-40">
          <div className="bg-white p-8 lg:p-16 rounded-3xl lg:rounded-[4rem] border border-slate-100 shadow-xl relative overflow-hidden group">
            ...
            <div className="space-y-4 lg:space-y-6 text-slate-500 font-medium leading-relaxed text-sm lg:text-base">
              <p>
          ...
          <div className="bg-purple-950 p-8 lg:p-16 rounded-3xl lg:rounded-[4rem] text-white shadow-2xl relative overflow-hidden group">
        ...
        <div className="mb-16 lg:mb-40">
          ...
          <div className="space-y-16 lg:space-y-32">
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-center">
              ...
              <div className="lg:w-2/3 w-full bg-slate-50 p-6 lg:p-16 rounded-2xl lg:rounded-[4rem] border border-slate-100 relative">
        ...
        <div className="mb-16 lg:mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            {[
              ...
              <div key={i} className="bg-white p-8 lg:p-12 rounded-2xl lg:rounded-[3.5rem] border border-slate-100 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 group">
                <div className="w-14 h-14 lg:w-20 lg:h-20 bg-purple-50 rounded-2xl lg:rounded-3xl flex items-center justify-center mb-6 lg:mb-8 text-purple-700 transition-colors group-hover:bg-purple-900 group-hover:text-white">
                ...
                <p className="text-slate-500 font-medium leading-relaxed text-sm lg:text-base">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-16 lg:mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
            {[
              ...
              <div key={i} className="p-6 lg:p-10 rounded-2xl lg:rounded-[3rem] border border-slate-100 bg-slate-50 transition-all">
                ...
                <p className="font-medium leading-relaxed text-slate-500 text-sm lg:text-base">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 mb-16 lg:mb-40">
          {/* Faculty */}
          <div className="bg-slate-50 p-6 lg:p-16 rounded-2xl lg:rounded-[4rem] border border-slate-100">
            <h2 className="text-2xl lg:text-4xl font-black text-purple-950 mb-4 lg:mb-8">Our Faculty</h2>
            <p className="text-sm lg:text-lg text-slate-600 font-medium leading-relaxed mb-6 lg:mb-10">
            ...
            <ul className="grid grid-cols-1 gap-3 lg:gap-4">
              {[
                ...
                <li key={i} className="flex items-center gap-3 lg:gap-4 bg-white p-4 lg:p-6 rounded-xl lg:rounded-2xl shadow-sm border border-slate-50">
                  ...
                  <span className="font-bold text-slate-700 text-sm lg:text-base">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Holistic */}
          <div className="bg-purple-900 p-6 lg:p-16 rounded-2xl lg:rounded-[4rem] text-white">
        ...
        {/* FAQ Section */}
        <section className="py-10 lg:py-24 bg-indigo-50/30 rounded-2xl lg:rounded-[4rem] relative overflow-hidden mb-16 lg:mb-32 border border-indigo-100">
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
            ...
            <div className="space-y-3 lg:space-y-4">
              {faqs.map((faq, idx) => (
                <div
                  key={idx}
                  className={`bg-white rounded-xl lg:rounded-[1.5rem] border transition-all duration-300 overflow-hidden ${openFaq === idx
                ...
                >
                  ...
                  >
                    <span className={`text-sm lg:text-lg font-bold transition-colors ${openFaq === idx ? 'text-purple-900' : 'text-slate-700'}`}>
                      {faq.question}
                    </span>
        ...
        <div className="bg-slate-900 rounded-2xl lg:rounded-[5rem] p-6 lg:p-20 text-white relative overflow-hidden mb-10 lg:mb-20">
          ...
          <div className="text-center mb-8 lg:mb-16 relative z-10">
            ...
            <p className="text-sm lg:text-xl text-slate-400 max-w-2xl mx-auto font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 relative z-10">
            {[
              ...
              <div key={i} className="bg-white/5 backdrop-blur-md border border-white/10 p-5 lg:p-10 rounded-xl lg:rounded-[3rem] hover:bg-white/10 transition-colors">
